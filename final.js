...
//       document.getElementById("loadOtherModel").textContent =
//         "Check Tshirt Model"; // Add this line
...
//     updateAllColors();
//     document.getElementById("loadOtherModel").textContent =
//       "Check Tshirt Model"; // Update button text
//     document.getElementById("loading").style.display = "none";
//     return;
//   }
...
//       updateAllColors();
//       document.getElementById("loadOtherModel").textContent =
//         "Check SpySport Model"; // Update button text
//       document.getElementById("loading").style.display = "none";
//     },
//     (xhr) =>
//       console.log(
//         `Second model ${((xhr.loaded / xhr.total) * 100).toFixed(2)}% loaded`
//       ),
//     (error) => {
//       document.getElementById("loading").textContent =
//         "Failed to load second model.";
